...
// Define the interface for Jet document
...
jetSchema.methods.calculatePrice = function(startDate: Date, endDate: Date) {
...
jetSchema.methods.isAvailableForBooking = async function(startDate: Date, endDate: Date) {
...
export default mongoose.model<IJet>('Jet', jetSchema);