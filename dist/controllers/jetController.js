...
export const createJet = async (req, res) => {
    try {
        const { name, type, location, passengers, range, cruiseSpeed, hourlyRate, dailyRate, weeklyRate, availability, availabilityNotes, description, amenities, images } = req.body;
        if (!name) {
...
export const updateJet = async (req, res) => {
    try {
        ...
        const updatedJet = await Jet.findByIdAndUpdate(req.params.id, updateData, { new: true, runValidators: true });
...
export const getAvailableJets = async (req, res) => {
    try {
...
//# sourceMappingURL=jetController.js.map